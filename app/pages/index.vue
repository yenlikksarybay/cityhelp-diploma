...
useSeo({
  ...
  description:
    "Сервис объединяет граждан и муниципальные службы, отображает проблемы на карте, автоматизирует обработку заявок, применяет ИИ для приоритизации и проходит ручную модерацию перед передачей в работу.",
});
