      ...
      <div class="goals__container">
        <div class="goals__intro" data-aos="fade-up">
          ...
          <p class="goals__lead">
            ...
            собираем сообщения жителей, проверяем их через AI и модерацию,
            связываем с ответственными службами и даем прозрачный путь от
            проблемы до решения.
          </p>
        </div>
          ...
          <div class="goals__card goals__card--tall" data-aos="fade-up">
            ...
            <ol class="goals__flow">
              <li class="goals__flow-item">
                Пользователь отправляет обращение: описание, фото и точку на
                карте.
              </li>
              <li class="goals__flow-item">
                AI анализирует обращение, определяет категорию, приоритет и
                срок.
              </li>
              <li class="goals__flow-item">
                Администратор или супер-администратор проверяет решение AI и
                подтверждает его.
              </li>
              <li class="goals__flow-item">
                Если всё ок, обращение уходит сотруднику в работу. Если нет, оно
                отклоняется или возвращается на доработку.
              </li>
              <li class="goals__flow-item">
                Сотрудник выполняет работу, прикладывает фото и комментарий.
              </li>
              <li class="goals__flow-item">
                Финальная проверка переводит обращение в завершённое состояние.
              </li>
              <li class="goals__flow-item">
                Пользователь оценивает результат, а система собирает аналитику
                по районам, статусам и качеству работы.
              </li>
            </ol>
          </div>
